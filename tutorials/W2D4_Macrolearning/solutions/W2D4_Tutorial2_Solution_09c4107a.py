...
def sequential_training(K: int, num_epochs: int):
    ...
    for _ in range(num_epochs // 2):
        ...
        model.partial_fit(summer_days_train_norm[sampled_summer_indeces], summer_prices_train[sampled_summer_indeces])
        ...
        model.partial_fit(autumn_days_train_norm[sampled_autumn_indeces], autumn_prices_train[sampled_autumn_indeces])
